...
const CreateAccountTypePCD = ({
  ...
  return (
    <View
      style={{ flexDirection: "column", paddingHorizontal: 20, height: "100%" }}
    >
      <Header />
      <View style={styles.body}>
        ...
        <View style={{ marginTop: 40 }}>
          <TouchableOpacity
            style={styles.radio}
            onPress={() => handlePressInput("visual")}
          >
          ...
          <TouchableOpacity
            style={styles.radio}
            onPress={() => handlePressInput("motora")}
          >
          ...
          <TouchableOpacity
            style={styles.radio}
            onPress={() => handlePressInput("mental")}
          >
          ...
          <TouchableOpacity
            style={styles.radio}
            onPress={() => handlePressInput("auditiva")}
          >
