...
export default function Chatbot({ navigation }) {
  ...
  const sendMessageToChatbot = async (value) => {
    ...
    const baseUrl =
      "https://api.us-south.assistant.watson.cloud.ibm.com/instances/95a280d6-bcc5-4145-8b77-9dd1dc47a386/v1/workspaces/ce71c9d2-0c4c-4fd5-b810-e32bfb81bc27/message";

    try {
      const request = await axios.post(
        baseUrl.concat("?version=2018-09-20"),
        { input: { text: value } },
        {
          headers: {
      ...
      if (!response)
        Speech.speak("Eu não entendi, você pode reformular a frase");
