        ...
        <View style={styles.formContainer}>
          ...
          <View style={{ marginTop: 10 }}>
            ...
            >
              <RadioButton
                selected={
                  user?.typePCD.includes("visual") || typePCD.includes("visual")
                }
              />
            ...
            >
              <RadioButton
                selected={
                  user?.typePCD.includes("motora") || typePCD.includes("motora")
                }
              />
            ...
            <TouchableOpacity
              style={styles.radio}
              onPress={() => setTypePCD((atual) => [...atual, "mental"])}
            >
              <RadioButton
                selected={
                  user?.typePCD.includes("mental") || typePCD.includes("mental")
                }
              />
            ...
            <TouchableOpacity
              style={styles.radio}
              onPress={() => setTypePCD((atual) => [...atual, "auditiva"])}
            >
              <RadioButton
                selected={
                  user?.typePCD.includes("auditiva") ||
                  typePCD.includes("auditiva")
                }
              />
